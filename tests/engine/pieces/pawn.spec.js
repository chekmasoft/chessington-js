...
describe("Pawn", () => {
  ...
  describe("white pawns", () => {
    ...
    it("can en passant", () => {
      ...
      board.movePiece(Square.at(6, 1), Square.at(4, 1));

      const moves = pawn.getAvailableMoves(board);

      moves.should.deep.include(Square.at(5, 1));
      let piecesAtNewSquare = [];
      if (!!board.getPiece(Square.at(4, 1)))
        piecesAtNewSquare.push(board.getPiece(Square.at(4, 1)));
      piecesAtNewSquare.should.not.contain(board.getPiece(Square.at(4, 1)));
    });
  });
  ...
  describe("black pawns", () => {
    ...
    it("can en passant", () => {
      ...
      board.setPiece(Square.at(1, 0), opposingPawn);
      board.currentPlayer = Player.WHITE;
      board.movePiece(Square.at(1, 0), Square.at(3, 0));

      console.log(board.history.at(-1));
      const moves = pawn.getAvailableMoves(board);

      moves.should.deep.include(Square.at(2, 0));
      let piecesAtNewSquare = [];
      if (!!board.getPiece(Square.at(3, 0)))
        piecesAtNewSquare.push(board.getPiece(Square.at(3, 0)));
      piecesAtNewSquare.should.not.contain(board.getPiece(Square.at(3, 0)));
    });
  });
